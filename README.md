...
- `SYNCHRONIZE_DELETED` - Whether to delete the dashboards from the target directory if they were not fetched from the Grafana instance, bool, defaults to `true`
